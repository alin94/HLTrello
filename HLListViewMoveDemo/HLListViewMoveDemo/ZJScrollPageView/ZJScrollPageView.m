...
- (void)reloadAtCurrentWithNewTitles:(NSArray<NSString *> *)newTitles {
    self.titlesArray = nil;
    self.titlesArray = newTitles.copy;
    [self.segmentView reloadTitlesAtCurrentWithNewTitles:newTitles];
    [self.contentView reload];
}
...
- (void)setNoSlide:(BOOL)noSlide {
    _noSlide = noSlide;
    self.contentView.noSlide = noSlide;
}
