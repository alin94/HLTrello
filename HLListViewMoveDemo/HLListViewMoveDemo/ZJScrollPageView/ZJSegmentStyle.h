...
/*lineView 是否是平均分的 默认NO 需设置scrollTitle = NO*/
@property (nonatomic, assign) BOOL aveScrollLineWidth;

@property (nonatomic, assign) BOOL shouldRecognizeSimultaneously;
/**是否显示底部的黑线 默认YES*/
@property (nonatomic, assign) BOOL showBottomLine;

@property (nonatomic, assign) BOOL scrollRotateExtraBtn;

/**第一个title距离屏幕的距离 默认 30*/
@property (nonatomic, assign) CGFloat firstTitleMargin;
/**滚动条底部间隔*/
@property (nonatomic, assign) CGFloat scrollLineBottomMargin;
/**滚动条宽度  跟autoAdjustTitlesWidth、autoAdjustTitlesWidth、aveScrollLineWidth不可同时使用*/
@property (nonatomic, assign) CGFloat scrollLineWidth;
/**滚动条圆角*/
@property (nonatomic, assign) CGFloat scrollLineCornerRadius;

@property (nonatomic, assign) CGFloat extraBtnRightMargin;

@property (nonatomic, assign) CGFloat lastTitleKeepRight;//最后一个靠右
@end
